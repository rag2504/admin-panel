...
export default function AdminUsers() {
  ...
  const loadUsers = async () => {
    setLoading(true);
    try {
      const response = await get(`/admin/users?page=${pagination.page}&limit=${pagination.limit}&search=${search}&status=${statusFilter}`);
      if (response.success) {
  ...
  const updateUserStatus = async (userId: string, field: 'isActive' | 'isVerified', value: boolean) => {
    try {
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => updateUserStatus(user._id, 'isActive', checked)}
                      />
                    </div>
                    <div className="flex items-center gap-2">
